...
![old_filter_time.png](old_filter_time.png)

![new_filter_time.png](new_filter_time.png)

* Старый код медленнее из-за ручных циклов, отсутствия функций, которые работают быстрее. 

![img.png](filter_with_filename.png)
* Скорость значительно выросла из-за выноса в отдельный файл ввод/вывод от пользователя.